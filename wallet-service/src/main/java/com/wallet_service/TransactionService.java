...
public class TransactionService {
	    ...
	    public void deposit(Integer userId,Integer walletId, BigDecimal amount) {
	    	Wallet wallet = walletRepo.findByWalletIdAndUserUserId(walletId,userId).orElseThrow(() -> new RuntimeException("Wallet not found"));
	    ...
	    public void withdraw(Integer userId,Integer walletId, BigDecimal amount) {
	    	Wallet wallet = walletRepo.findByWalletIdAndUserUserId(walletId,userId).orElseThrow(() -> new RuntimeException("Wallet not found"));
	        BigDecimal balance = wallet.getBalance();
